<%@ Page Title="" Language="C#" MasterPageFile="~/vegefoods.Master" AutoEventWireup="true" CodeBehind="demo_ajax_shop.aspx.cs" Inherits="DoAn_ASP.demo_ajax_shop" %>
<asp:Content ID="Content1" ContentPlaceHolderID="css" runat="server">
    ...
    <script src="js/ajax_shop.js"></script>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="shop.asp">Home</a></span> <span>Products</span></p>
    	...
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category" id="show-list-filter">
                        ...
                        <asp:Repeater ID="repeater_filter" runat="server">
                            <ItemTemplate>
                                <li>
                                    ...
                                    <a href="demo_ajax_shop.aspx<%# (Eval("type_id").ToString()=="0"?"":"?filter="+ Eval("type_id").ToString())%>" class="<%# (Convert.ToInt32(Eval("active").ToString())==1?"active":"not_active")%>"><input type="button" value="<%# Eval("type_name") %>" class="active"></input></a>
                                </li>
                            </ItemTemplate>
                        </asp:Repeater>
                    ...
                    <input  type="hidden" id="hf_filter" value=""/>
                    <input  type="hidden" id="hf_pagecurrent" value=""/>
    			</div>
    		</div>
