              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                    <canvas id="myAreaChart" width="514" height="160" class="chartjs-render-monitor" style="display: block; width: 514px; height: 160px;"></canvas>
                  </div>
                  <hr>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-bar"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                    <canvas id="myBarChart" width="514" height="160" class="chartjs-render-monitor" style="display: block; width: 514px; height: 160px;"></canvas>
                  </div>
                  <hr>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                    <canvas id="myPieChart" width="514" height="216" class="chartjs-render-monitor" style="display: block; width: 514px; height: 216px;"></canvas>
                  </div>
                  <hr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" Runat="Server">
  ...
  <script src="<%=Page.ResolveUrl("~/admin/") %>js/demo/chart-area-demo.js"></script>
  <script src="<%=Page.ResolveUrl("~/admin/") %>js/demo/chart-pie-demo.js"></script>
  <script src="<%=Page.ResolveUrl("~/admin/") %>js/demo/chart-bar-demo.js"></script>
</asp:Content>
