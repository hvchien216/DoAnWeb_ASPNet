<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vegefood1.aspx.cs" enableEventValidation="false" Inherits="DoAn_ASP.vegefood" %>
...
<body class="goto-here">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="vegefood.aspx" class="nav-link">Home</a></li>
	          ...
	          <li class="nav-item cta cta-colored"><a href="cart.aspx" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		<div class="row">
    			<asp:Repeater ID="reapeater_product" runat="server" OnItemCommand="reapeater_product_ItemCommand">
                    <ItemTemplate>
                        <div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="product-single.aspx?id=<%# Eval("id") %>" class="img-prod"><img class="img-fluid" style="width:253px;height:202px" src="<%# Eval("img","/admin/img/{0}") %>" alt="Colorlib Template">
    					...
    					&nbsp;<div class="text py-3 pb-4 px-3 text-center">
	    					...
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
                                    ...
                                    <asp:Button ID="btn_cart" CommandName="Add_To_Cart" runat="server" Text="Add to cart" />
	    							</a>
    							</div>
    						</div>
    					</div>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
          	<span class="subheading">Best Price For You>
