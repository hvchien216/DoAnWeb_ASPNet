<%@ Page Title="" Language="C#" MasterPageFile="~/vegefoods.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DoAn_ASP.index" %>
    ...
    <section id="home-section" class="hero">
		  <div class="home-slider owl-carousel">
              <asp:Repeater ID="repeater_slider" runat="server">
                  <ItemTemplate>
                      <div class="slider-item" style="background-image: url('<%# Eval("img","/admin/img/{0}") %>');">
                          <div class="overlay"></div>
                          <div class="container">
                              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

                                  <div class="col-md-12 ftco-animate text-center">
                                      <h1 class="mb-2"><%# Eval("capotion") %></h1>
	    					...
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
                                    ...
                                    <asp:HiddenField ID="hf_thumb" Value='<%# Eval("thumb") %>' runat="server" />
                                        <asp:Button ID="btn_cart" CssClass="add-to-cart" CommandName="Add_To_Cart" Text="+" runat="server"  />
    							</div>
    						</div>
    					</div>
    				</div>
